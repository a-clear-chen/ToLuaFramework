...
public class UnityEngine_CameraWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("IsDistributedCamera", get_IsDistributedCamera, set_IsDistributedCamera);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_IsDistributedCamera(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			bool ret = obj.IsDistributedCamera;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index IsDistributedCamera on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_IsDistributedCamera(IntPtr L)
	{
		object o = null;
